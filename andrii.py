...
class MainWindow(CTk):
    def __init__(self):
        ...
        self.btn = CTkButton(self, text="▶️", command=self.toggle_show_menu, width=30, fg_color = "green", hover_color = "dark green")
        ...
        self.send_button = CTkButton(self, text=">", width=50, height=40, command=self.send_message, fg_color="green",hover_color = "dark green")
    ...
    def toggle_show_menu(self):
        if self.is_show_menu:
            ...
            self.entry.pack()
            self.save_name_button = CTkButton(self.menu_frame, text="Зберегти", command = self.save_name,fg_color="green", hover_color = "dark green",corner_radius=15,text_color="white")
    ...
    def save_name(self):
        ...
        if new_name:
            ...
            self.add_message(f"[SYSTEM] Ім`я змінено на: {new_name}")
